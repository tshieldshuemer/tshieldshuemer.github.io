...
modDatetime: 2026-06-08T04:58:53Z
title: Glasgow
description: ""
featured: false
draft: false
...
<div class="not-prose">
  <div class="columns-2 md:columns-3 gap-4 max-w-3xl mx-auto">
    ...
    <img src="/SkyMills.jpg" alt="Sky Mills" class="lightbox-trigger w-full mb-4 border-4 border-black cursor-pointer hover:opacity-90 transition rounded-sm" />
    ...
    <img src="/SkyTower.jpg" alt="Sky Tower" class="lightbox-trigger w-full mb-4 border-4 border-black cursor-pointer hover:opacity-90 transition rounded-sm" />
    <img src="/ZahaHadidMuseum.jpg" alt="Zaha Hadid Museum" class="lightbox-trigger w-full mb-4 border-4 border-black cursor-pointer hover:opacity-90 transition rounded-sm" />
  </div>
</div>
